...
?>
			...
			<div id="site-generator">
				...
				<a href="<?php echo esc_url('https://e42.xyz/'); ?>" title="Twenty Ten Dark Child Theme">
					Twenty Ten Dark
				</a>
				by 
				<a href="<?php echo esc_url('https://e42.xyz/'); ?>" title="e42.xyz WordPress Development">
					e42.xyz web dev
				</a>
			</div><!-- #site-generator -->
...
<div class="scroll-top">
	<a href="#"><?php echo __('Back to Top', 'twentyten'); ?> &uarr;</a>
</div>
*/ ?>
<?php
	/*
