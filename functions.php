 ...
 */
function darktt_theme_styles() {
	wp_enqueue_style('darktt-style', get_stylesheet_directory_uri().'/css/dark.css', false, 0.1);
	wp_enqueue_script( 'darktt-menu', get_stylesheet_directory_uri() . '/js/twentyten-script.js', array('jquery'), false, 0.1);
}
add_action('wp_enqueue_scripts', 'darktt_theme_styles');
